...
2. Enter: `https://github.com/Pippapips/ZenECS_deprecated.git?path=Packages/com.zenecs.core#v1.0.0`

### Step 2: Install Unity Adapter

1. Package Manager → **+** → **Add package from git URL**
2. Enter: `https://github.com/Pippapips/ZenECS_deprecated.git?path=Packages/com.zenecs.adapter.unity#v1.0.0`
