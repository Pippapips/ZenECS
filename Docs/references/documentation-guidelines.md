...
└── i18n/              # Localized content (Korean, etc.)
```
...
- **Secondary languages**: Korean (in `i18n/ko/`)
...
- All new documentation starts in English
- English documentation is the source of truth

### Secondary Languages

- **Korean** translations in `i18n/ko/`
- Translate key documents: Getting Started, FAQ, Quick Start
- Keep translations in sync with English versions
- Mark incomplete translations: `[⚠️ Translation in progress]`
