...
namespace ZenECS.Core.Internal.Hooking
{
    ...
    {
        void AddWritePermission(Func<IWorld, Entity, Type, bool> hook);
        bool RemoveWritePermission(Func<IWorld, Entity, Type, bool> hook);
        void ClearWritePermissions();
        void AddReadPermission(Func<IWorld, Entity, Type, bool> hook);
        bool RemoveReadPermission(Func<IWorld, Entity, Type, bool> hook);
        ...
        bool EvaluateWritePermission(IWorld w, Entity e, Type t);
        bool EvaluateReadPermission(IWorld w, Entity e, Type t);
