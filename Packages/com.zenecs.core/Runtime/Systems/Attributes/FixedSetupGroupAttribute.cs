...
{
    /// <summary>
    /// Marks a system as belonging to the <b>FixedSetup</b> group.
    /// <para>Typical usage: input snapshot, delta time calculation, or queue swapping before fixed step enter</para>
    /// </summary>
    [AttributeUsage(AttributeTargets.Class, Inherited = false, AllowMultiple = false)]
    public sealed class FixedSetupGroupAttribute : Attribute { }
}