...
public sealed class SystemsPresetInspector : Editor
{
    ...
    void OnEnable()
    {
        ...
        _list = new ReorderableList(serializedObject, _propTypes, draggable: true, displayHeader: true, displayAddButton: true, displayRemoveButton: true);
        _list.drawHeaderCallback = rect => EditorGUI.LabelField(rect, "System Types (ISystem)", EditorStyles.boldLabel);
        ...
        _list.drawElementCallback = (rect, index, active, focused) =>
        {
            ...
            var lineRect = new Rect(rect.x + 6, rect.y + 3, rect.width - 12, EditorGUIUtility.singleLineHeight + 10);
            ...
            {
                var style = new GUIStyle(EditorStyles.label) { normal = { textColor = new Color(1f, 0.35f, 0.35f) } };
