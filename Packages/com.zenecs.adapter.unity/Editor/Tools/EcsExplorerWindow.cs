...
namespace ZenECS.EditorTools
{
    public sealed class EcsExplorerWindow : EditorWindow
    {
        ...
        void OnGUI()
        {
            ...
            if (_driver != null && _driver.Kernel != null)
            {
        ...
        bool TryResolveEntityById(object world, int id, out Entity e)
        {
            ...
            // var miIsAlive = wType.GetMethod("IsAlive", new[] { typeof(Entity) });
            // if (miIsAlive != null)
            // {
            //     try
            //     {
                ...
                foreach (var (t, boxed) in compsArray)
                {
                    ...
                    using (new EditorGUILayout.VerticalScope("box"))
                    {
                        ...
                        try
                        {
                            ...
                            //if (EditorGUI.EndChangeCheck() && _editMode) EcsExplorerApply.SetBoxed(world, e, obj);
                        }
