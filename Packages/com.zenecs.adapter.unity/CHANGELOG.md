...
All notable changes to ZenECS Adapter Unity will be documented in this file.
...
- Enhanced Unity integration features
...
#### Documentation
- Complete Unity adapter documentation
...
4. **Update Dependencies**: Ensure compatible Core version
...
**Note:** This changelog is maintained manually. For detailed API changes, see the [Unity Adapter Documentation](../../Docs/adapter-unity/).
